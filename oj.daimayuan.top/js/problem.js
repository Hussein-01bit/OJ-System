...
if (this_user == null || (localStorage.getItem("problem-id=" + id + "?see") == 0 && !(localStorage.getItem("uoj-user_" + this_user + "_gler") > 0) && localStorage.getItem("problem-id=" + id + "?" + this_user + "_gler") == null) || contname == null) {
