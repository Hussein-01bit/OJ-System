...
<html lang="zh-cn">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1" />
				<title>题库 - Daimayuan Online Judge</title>
...
<div class="row">
	<div class="col-sm-4">
		<ul class="nav nav-pills" role="tablist"><li class="nav-item"><a class="nav-link active" href="" role="tab">总题库</a></li>
		<script type="text/javascript">
		if (uoj_username != null && localStorage.getItem("uoj-user_" + uoj_username + "_gler") > 0) 
			document.write('<li class="nav-item" style="margin-left: 5px;"><a class="nav-link active" href="problem/add_problem.html" role="tab">新建题目</a></li>');
		</script></ul>
	</div>

	<div class="col-sm-4 order-sm-5">
	<ul class="pagination top-buffer-no bot-buffer-sm justify-content-center"><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-fast-backward"></span></a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-backward"></span></a></li><li class="page-item active"><a class="page-link" href="">1</a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-forward"></span></a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-fast-forward"></span></a></li></ul>	</div>

</div>
<div class="table-responsive"><table class="table table-bordered table-hover table-striped"><thead><tr><th class="text-center" style="width:5em;">ID</th><th>题目</th><th class="text-center" style="width:200px;">评价</th></tr></thead><tbody>
<script>
window.zan_cnt = 0;
for (var i = 1; i <= Number(localStorage.getItem("problem-lastid")); i++) {
	if (localStorage.getItem("problem-id=" + i + "?name") != null) {
		if (localStorage.getItem("problem-id=" + i + "?see") == 1) {
			document.write('<tr class="text-center"><td' + ((uoj_username != null && localStorage.getItem("problem-id=" + i + "?user=" + uoj_username + "&ac") >= 100) ? ' class="table-success"' : '') + '>#' + i + '</td><td class="text-left"><a href="problem/' + i + '.html">' + localStorage.getItem("problem-id=" + i + "?name") + ' </a></td><td class="text-left"><div class="uoj-click-zan-block" data-id="' + i + '" data-type="P"></div></td></tr>');
			zan_cnt++;
		}
		else if (uoj_username != null && Number(localStorage.getItem("uoj-user_" + uoj_username + "_gler")) > 0) {
			document.write('<tr class="text-center"><td' + ((localStorage.getItem("problem-id=" + i + "?user=" + uoj_username + "&ac") >= 100) ? ' class="table-success"' : '') + '>#' + i + '</td><td class="text-left"><span style="color: red;">[隐藏]</span><a href="problem/' + i + '.html">' + localStorage.getItem("problem-id=" + i + "?name") + ' </a></td><td class="text-left"><div class="uoj-click-zan-block" data-id="' + i + '" data-type="P"></div></td></tr>');
			zan_cnt++;
		}
		else 
			document.write('\n');
	...
	<ul class="pagination top-buffer-no bot-buffer-sm justify-content-center"><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-fast-backward"></span></a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-backward"></span></a></li><li class="page-item active"><a class="page-link" href="">1</a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-forward"></span></a></li><li class="page-item disabled"><a class="page-link"><span class="glyphicon glyphicon glyphicon-fast-forward"></span></a></li></ul>
			</div>
